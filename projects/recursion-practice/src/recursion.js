...
//Use a ternary operator to check if the length of the array is 0
//if true return zero
//if not return the first index of the array plus the sum function with the first index sliced off as the parameter
