...
function greeter(hour) {
    ...
    // Create an if statement that will print a specific message depending on what hour you input
    // Use comparison operators in my expression to include the set of numbers I need.
    if (hour > -1 && hour < 12) {
